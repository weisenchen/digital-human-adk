...
def create_app() -> FastAPI:
    ...
    async def talk_show_ask(
        ...
        system_parts = [
            ...
            "── SOUND EFFECTS ──",
            "STRICT RULES:",
            "- NEVER describe sounds, audience reactions, or actions in words.",
            "  WRONG: *audience applause* or (audience laughs) or [Lights up]",
            "  WRONG: describing what you're doing like 'I stride to center stage'",
            "  INSTEAD: just speak your lines naturally.",
            "- If a sound would genuinely add to the show, append ONLY the tag at the very end.",
            "  Example: \"Welcome to the show! {{APPLAUSE}}\"",
            "  Example: \"That's hilarious! {{LAUGH}}\"",
            "  Example: \"Let's dive into the main topic. {{WHOOSH}}\"",
            "Available sounds: {{APPLAUSE}}, {{LAUGH}}, {{WHOOSH}}",
            "- {{APPLAUSE}}: After opening announcement, after closing, impressive insight",
            "- {{LAUGH}}: After a funny remark or joke",
            "- {{WHOOSH}}: Between segment transitions",
            "- Most responses have NO sound effect. Only use when it truly fits.",
        ]
